...
@if(settings('encrypted::pterodactyl::api_admin_key', false))
    @section('content')
        <div class="container mx-auto px-4">
            @include(Theme::serviceView('pterodactyl', 'plugins.spigot.search'))
            @include(Theme::serviceView('pterodactyl', 'plugins.spigot.categories'))
            @include(Theme::serviceView('pterodactyl', 'plugins.spigot.plugins'))
