<!-- Confirm Modal -->
<div id="confirm-modal{{ $backup['attributes']['uuid'] }}" tabindex="-1"
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <button type="button"
                    ...
                    data-modal-hide="confirm-modal{{ $backup['attributes']['uuid'] }}">
            ...
            <div class="p-4 md:p-5 text-center">
                ...
                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">{!! __('client.confirm_deletion_backup') !!}: {{ $backup['attributes']['name'] }}?</h3>
                <form action="{{ route('pterodactyl.backups.delete', ['server' => $server['identifier'], 'order' => $order->id]) }}"
                    ...
                    <button data-modal-hide="confirm-modal{{ $backup['attributes']['uuid'] }}"
                            type="button"
