        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5">
                <div class="grid gap-4 mb-4 grid-cols-1">
                    <form
                        action="{{ route('pterodactyl.schedules.update', ['server' => $server, 'order' => $order->id]) }}"
                        method="POST">
                        @csrf
                        ...
                        <div class="col-span-2 mb-3">
                            ...
                            <input required type="text" value="{{ $schedule['name'] }}" id="name" name="name"
                        ...
                        <div class="mb-3 grid grid-cols-5 gap-4">
                            <div class="col-span-1 mb-3">
                                ...
                                <input required type="text" value="{{ $schedule['cron']['minute'] }}" id="minute"
                                       name="minute"
                                       class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 w-full">
                            </div>
                            <div class="col-span-1 mb-3">
                                ...
                                <input required type="text" value="{{ $schedule['cron']['hour'] }}" id="hour"
                                       name="hour"
                                       class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 w-full">
                            </div>
                            <div class="col-span-1 mb-3">
                                ...
                                <input required type="text" value="{{ $schedule['cron']['day_of_month'] }}"
                            ...
                            <div class="col-span-1 mb-3">
                                ...
                                <input required type="text" value="{{ $schedule['cron']['month'] }}" id="month"
                                       name="month"
                                       class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 w-full">
                            </div>
                            <div class="col-span-1 mb-3">
                                ...
                                <input required type="text" value="{{ $schedule['cron']['day_of_week'] }}"
                        ...
                        <div class="col-span-2 mb-3">
                            ...
                            <select id="is_active" name="is_active"
                                ...
                                <option @if($schedule['is_active']) selected
                                        @endif value="1">{{ __('admin.yes') }}</option>
                                <option @if(!$schedule['is_active']) selected
                                        @endif value="0">{{ __('admin.no') }}</option>
                            </select>
                        </div>
                        ...
                        <div class="col-span-2 mb-3">
                            ...
                            <select id="only_when_online" name="only_when_online"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                <option @if($schedule['only_when_online']) selected
                                        @endif value="1">{{ __('admin.yes') }}</option>
                                <option @if(!$schedule['only_when_online']) selected
                                        @endif value="0">{{ __('admin.no') }}</option>
                            </select>
