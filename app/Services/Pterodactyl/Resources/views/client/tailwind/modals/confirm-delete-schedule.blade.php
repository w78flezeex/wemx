    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5 text-center">
                ...
                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">{!! __('client.confirm_deletion_schedule') !!}
                    : {{ $schedule['name'] }}?</h3>
                <form class="inline-flex"
                      action="{{ route('pterodactyl.schedules.delete', ['server' => $server, 'order' => $order->id]) }}"
                      method="POST">
                    @csrf
                    ...
                    <button data-modal-hide="confirm-modal"
                            type="button"
