<!-- Confirm Modal -->
<div id="confirm-modal{{ $database['attributes']['id'] }}" tabindex="-1"
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <button type="button"
                    ...
                    data-modal-hide="confirm-modal{{ $database['attributes']['id'] }}">
            ...
            <div class="p-4 md:p-5 text-center">
                ...
                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">{!! __('client.confirm_deletion_database') !!}: {{ $database['attributes']['name'] }}?</h3>
                <form action="{{ route('pterodactyl.databases.delete', ['server' => $server['identifier'], 'order' => $order->id]) }}"
                    ...
                    <button data-modal-hide="confirm-modal{{ $database['attributes']['id'] }}"
                            type="button"
