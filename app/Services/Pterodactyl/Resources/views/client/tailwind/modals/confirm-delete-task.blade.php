...
<div id="confirm-delete-task{{ $task['attributes']['id'] }}" tabindex="-1"
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <button type="button"
                    ...
                    data-modal-hide="confirm-delete-task{{ $task['attributes']['id'] }}">
            ...
            <div class="p-4 md:p-5 text-center">
                ...
                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400 text-center">{!! __('client.confirm_deletion_task') !!}</h3>
                <form class="inline-flex"
                      action="{{ route('pterodactyl.schedules.delete_task', ['server' => $server, 'order' => $order->id]) }}"
                      method="POST">
                    @csrf
                    ...
                    <button data-modal-hide="confirm-delete-task{{ $task['attributes']['id'] }}"
                            type="button"
