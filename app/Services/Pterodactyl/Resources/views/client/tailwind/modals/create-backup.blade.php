            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5">
                    <div class="grid gap-4 mb-4 grid-cols-1">
                        <form action="{{ route('pterodactyl.backups.create', ['server' => $server['identifier'], 'order' => $order->id]) }}"
                              method="POST">
                            @csrf
                            ...
                            <div class="col-span-2 mt-4">
                                <label for="ignored"
                                       class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{!! __('client.ignored_files') !!}</label>
                                <textarea type="text" name="ignored" id="ignored" rows="5"
                                          class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 w-full"></textarea>
                            </div>
                            <button type="submit"
