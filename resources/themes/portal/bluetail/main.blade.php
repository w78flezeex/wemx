...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="scroll-smooth">
  <head>
    ...
    <link rel="stylesheet" href="assets/themes/bluetail/css/swiper-bundle.min.css" />
    <link rel="stylesheet" href="assets/themes/bluetail/css/animate.css" />
    <link rel="stylesheet" href="assets/themes/bluetail/css/tailwind.css" />

    <!-- ==== WOW JS ==== -->
    <script src="assets/themes/bluetail/js/wow.min.js"></script>
    <script>
      new WOW().init();
    </script>
  </head>
  ...
  <body>
        ...
        <div class="relative -mx-4 flex items-center justify-between">
          <div class="w-60 max-w-full px-4">
            <a href="/" class="navbar-logo block w-full py-5">
                <span class="text-white text-3xl font-bold leading-snug">@settings('app_name')</span>
            </a>
          </div>
          <div class="flex w-full items-center justify-between px-4">
            ...
            <div class="flex items-center justify-end pr-16 lg:pr-0">
              ...
              <div class="hidden sm:flex">
                ...
                @else 
                <a
                href="{{ route('dashboard') }}" style="margin-left: 20px;"
                class="signUpBtn rounded-md bg-white ml-2 bg-opacity-20 px-6 py-2 text-base font-medium text-white duration-300 ease-in-out hover:bg-opacity-100 hover:text-dark"
                 >
                    Dashboard
                </a>
                @endguest
        ...
        <div class="-mx-4 flex flex-wrap items-center">
          <div class="w-full px-4">
            ...
            >
              ...
              >
                @settings('portal::bluetail::title', 'Open-Source Web Template for SaaS, Startup, Apps, and More')
              </h1>
              <p
                class="mx-auto mb-9 max-w-[600px] text-base font-medium text-white sm:text-lg sm:leading-[1.44]"
              >
                @settings('portal::bluetail::description', 'Multidisciplinary Web Template Built with Your Favourite Technology - HTML Bootstrap, Tailwind and React NextJS.')
              </p>
              <ul
          ...
          <div class="w-full px-4">
            ...
            >
              <div class="mt-16">
                <img
                  src="@settings('portal::bluetail::header_image', 'https://dev2.wemx.net/assets/themes/bluetail/images/hero/hero-image.jpg')"
                  alt="hero"
            ...
            <div class="w-full px-4 lg:w-1/2">
              <div class="-mx-2 flex flex-wrap sm:-mx-4 lg:-mx-2 xl:-mx-4">
                <div class="w-full px-2 sm:w-1/2 sm:px-4 lg:px-2 xl:px-4">
                  ...
                  >
                    <img
                      src="assets/themes/bluetail/images/about/about-image-01.jpg"
                      alt="about image"
                ...
                <div class="w-full px-2 sm:w-1/2 sm:px-4 lg:px-2 xl:px-4">
                  ...
                  >
                    <img
                      src="assets/themes/bluetail/images/about/about-image-02.jpg"
                      alt="about image"
                      class="h-full w-full object-cover object-center"
                    />
                  </div>
        ...
        @endif
          <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            ...
            >
              ...
              >
                <span class="text-xl font-medium">{{ currency('symbol') }}</span>
                <span class="-ml-1 -tracking-[2px]">{{ $package->prices->first()->renewal_price }}</span>
                <span
              ...
              <a
                href="{{ route('store.package', ['package' => $package->id]) }}"
              ...
              <div class="swiper-slide">
                ...
                >
                  <div class="mb-[18px] flex items-center gap-[2px]">
                    <img
                      src="assets/themes/bluetail/images/testimonials/icon-star.svg"
                      alt="star icon"
                    />
                    <img
                      src="assets/themes/bluetail/images/testimonials/icon-star.svg"
                  ...
                  <a href="#" class="flex items-center gap-4">
                    <div class="h-[50px] w-[50px] overflow-hidden rounded-full">
                      <img
                        src="assets/themes/bluetail/images/testimonials/author-01.jpg"
                        alt="author"
              ...
              <div class="swiper-slide">
                ...
                >
                  ...
                  <a href="#" class="flex items-center gap-4">
                    <div class="h-[50px] w-[50px] overflow-hidden rounded-full">
                      <img
                        src="assets/themes/bluetail/images/testimonials/author-02.jpg"
                        alt="author"
                        class="h-[50px] w-[50px] overflow-hidden rounded-full"
                      />
                    </div>
              ...
              <div class="swiper-slide">
                ...
                >
                  ...
                  <a href="#" class="flex items-center gap-4">
                    <div class="h-[50px] w-[50px] overflow-hidden rounded-full">
                      <img
                        src="assets/themes/bluetail/images/testimonials/author-03.jpg"
                        alt="author"
                        class="h-[50px] w-[50px] overflow-hidden rounded-full"
                      />
                    </div>
        ...
        <div class="-mx-4 flex flex-wrap justify-center">
          <div class="w-full px-4 sm:w-1/2 lg:w-1/4 xl:w-1/4">
            ...
            >
              <div class="relative z-10 mx-auto mb-5 h-[120px] w-[120px]">
                <img
                  src="assets/themes/bluetail/images/team/team-01.png"
                  alt="team image"
          ...
          <div class="w-full px-4 sm:w-1/2 lg:w-1/4 xl:w-1/4">
            ...
            >
              <div class="relative z-10 mx-auto mb-5 h-[120px] w-[120px]">
                <img
                  src="https://cdn.tailgrids.com/1.0/assets/themes/bluetail/images/team/image-07/image-02.png"
                  alt="team image"
                  class="h-[120px] w-[120px] rounded-full"
                />
                <span
          ...
          <div class="w-full px-4 sm:w-1/2 lg:w-1/4 xl:w-1/4">
            ...
            >
              <div class="relative z-10 mx-auto mb-5 h-[120px] w-[120px]">
                <img
                  src="https://cdn.tailgrids.com/1.0/assets/themes/bluetail/images/team/image-07/image-03.png"
                  alt="team image"
                  class="h-[120px] w-[120px] rounded-full"
                />
                <span
          ...
          <div class="w-full px-4 sm:w-1/2 lg:w-1/4 xl:w-1/4">
            ...
            >
              <div class="relative z-10 mx-auto mb-5 h-[120px] w-[120px]">
                <img
                  src="https://cdn.tailgrids.com/1.0/assets/themes/bluetail/images/team/image-07/image-04.png"
                  alt="team image"
                  class="h-[120px] w-[120px] rounded-full"
                />
                <span
    ...
    <section class="bg-white pb-10 pt-20 dark:bg-dark lg:pb-20 lg:pt-[120px]">
      <div class="container mx-auto">
        ...
        <div class="-mx-4 flex flex-wrap">
        @php 
            $news = \App\Models\Article::orderBy('created_at', 'desc')->take(3)->get();
        @endphp
        @foreach($news as $new)
          <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            <div class="wow fadeInUp group mb-10" data-wow-delay=".1s">
              <div>
                ...
                <h3>
                  <a
                    href="{{ route('news.article', $new->path) }}"
      ...
      <div class="container px-4">
        ...
        >
          <a href="https://graygrids.com/">
            <img
              src="assets/themes/bluetail/images/brands/graygrids.svg"
              alt="graygrids"
              class="dark:hidden"
            />
            <img
              src="assets/themes/bluetail/images/brands/graygrids-white.svg"
              alt="graygrids"
          ...
          <a href="https://lineicons.com/">
            <img
              src="assets/themes/bluetail/images/brands/lineicons.svg"
              alt="lineicons"
              class="dark:hidden"
            />
            <img
              src="assets/themes/bluetail/images/brands/lineicons-white.svg"
              alt="graygrids"
              class="hidden dark:block"
            />
          </a>
          <a href="https://uideck.com/">
            <img
              src="assets/themes/bluetail/images/brands/uideck.svg"
              alt="uideck"
              class="dark:hidden"
            />
            <img
              src="assets/themes/bluetail/images/brands/uideck-white.svg"
              alt="graygrids"
              class="hidden dark:block"
            />
          </a>
          <a href="https://ayroui.com/">
            <img
              src="assets/themes/bluetail/images/brands/ayroui.svg"
              alt="ayroui"
              class="dark:hidden"
            />
            <img
              src="assets/themes/bluetail/images/brands/ayroui-white.svg"
              alt="graygrids"
              class="hidden dark:block"
            />
          </a>
          <a href="https://tailgrids.com/">
            <img
              src="assets/themes/bluetail/images/brands/tailgrids.svg"
              alt="tailgrids"
              class="dark:hidden"
            />
            <img
              src="assets/themes/bluetail/images/brands/tailgrids-white.svg"
              alt="graygrids"
              class="hidden dark:block"
            />
          </a>
    ...
    >
        ...
        <div class="-mx-4 flex flex-wrap">
          <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
            <div class="mb-10 w-full">
              ...
              >
                <img
                  src="assets/themes/bluetail/images/logo/logo-white.svg"
                  alt="logo"
                  class="max-w-full"
                />
              </a>
              ...
              <div class="flex flex-col gap-8">
                ...
                >
                  <div class="overflow-hidden rounded">
                    <img
                      src="assets/themes/bluetail/images/blog/blog-footer-01.jpg"
                      alt="blog"
                    />
                  </div>
                  <span
                ...
                >
                  <div class="overflow-hidden rounded">
                    <img
                      src="assets/themes/bluetail/images/blog/blog-footer-02.jpg"
                      alt="blog"
                    />
                  </div>
                  <span
      ...
      <div>
        <span class="absolute left-0 top-0 z-[-1]">
          <img src="assets/themes/bluetail/images/footer/shape-1.svg" alt="" />
        </span>

        <span class="absolute bottom-0 right-0 z-[-1]">
          <img src="assets/themes/bluetail/images/footer/shape-3.svg" alt="" />
        </span>
    ...
    <script src="assets/themes/bluetail/js/swiper-bundle.min.js"></script>
    <script src="assets/themes/bluetail/js/main.js"></script>
    <script>
      // ==== for menu scroll
