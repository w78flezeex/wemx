...
class OrderUnsuspendedListener implements ShouldQueue
{
    use InteractsWithQueue;

    public static string $title = 'Order Unsuspended';
    public static string $description = 'An order has been unsuspended';
    ...
    public function handle($event): void
    {
        try {
            ...
            ErrorLog('discordwebhook:order_unsuspended', $e->getMessage());
        }
