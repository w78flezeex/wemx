...
class OrderRenewedListener implements ShouldQueue
{
    use InteractsWithQueue;

    public static string $title = 'Order Renew';
    public static string $description = 'An order has been renewed';
    ...
    public function handle($event): void
    {
        try {
            ...
            ErrorLog('discordwebhook:order_renewed', $e->getMessage());
        }
