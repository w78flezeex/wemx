...
class OrderSuspendedListener implements ShouldQueue
{
    use InteractsWithQueue;

    public static string $title = 'Order Suspended';
    public static string $description = 'An order has been suspended';
    ...
    public function handle($event): void
    {
        try {
            ...
            ErrorLog('discordwebhook:order_suspended', $e->getMessage());
        }
